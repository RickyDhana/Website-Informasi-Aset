...
<html>
<head>
    <title>Tambah Data Alat Ukur</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-6">
    <div class="max-w-lg mx-auto bg-white shadow-md rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-4">Tambah Data Alat Ukur</h2>
        ...
        <form action="{{ route('admin.store', [$jenis, $divisi]) }}" method="POST">
            ...
            <div class="mb-4">
                <label class="block font-semibold">Range</label>
                <input type="text" name="range" class="w-full border p-2 rounded">
            </div>
