...
<html>
<head>
    <title>Data Alat Ukur Kaprang - Admin</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-6">

    <h1 class="text-2xl font-bold mb-4">Data Alat Ukur Kaprang (Admin)</h1>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border text-center">
                        ...
                        <form action="{{ route('admin.delete', [$jenis, $divisi, $row->id]) }}" 
                              method="POST" 
                              class="inline">
                            @csrf
                            @method('DELETE')
